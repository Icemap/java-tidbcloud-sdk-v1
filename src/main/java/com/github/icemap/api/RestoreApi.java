...
import com.github.icemap.model.CreateRestoreReq;
import com.github.icemap.model.CreateRestoreResp;
import com.github.icemap.model.GetRestoreResp;
import com.github.icemap.model.ListRestoreResp;
...
public class RestoreApi {
    ...
    /* Build call for createRestoreTask */
    private com.squareup.okhttp.Call createRestoreTaskCall(String projectId, CreateRestoreReq body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        
        // verify the required parameter 'projectId' is set
        if (projectId == null) {
            throw new ApiException("Missing the required parameter 'projectId' when calling createRestoreTask(Async)");
        }
        
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling createRestoreTask(Async)");
        }
        

        // create path and map variables
        String localVarPath = "/api/v1beta/projects/{project_id}/restores".replaceAll("\\{format\\}","json")
     ...
     * @param body  (required)
     * @return CreateRestoreResp
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public CreateRestoreResp createRestoreTask(String projectId, CreateRestoreReq body) throws ApiException {
        ApiResponse<CreateRestoreResp> resp = createRestoreTaskWithHttpInfo(projectId, body);
        return resp.getData();
    }
     ...
     * @param projectId The ID of the project. You can get the project ID from the response of [List all accessible projects.](#tag/Project/operation/ListProjects). (required)
     * @param body  (required)
     * @return ApiResponse&lt;CreateRestoreResp&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<CreateRestoreResp> createRestoreTaskWithHttpInfo(String projectId, CreateRestoreReq body) throws ApiException {
        com.squareup.okhttp.Call call = createRestoreTaskCall(projectId, body, null, null);
        Type localVarReturnType = new TypeToken<CreateRestoreResp>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Create a restore task. (asynchronously)
     * You can use this endpoint to restore data from a previously created backup file to a new cluster. In this endpoint, you must specify the configuration of the new cluster you want to restore data to.  **Limitations:**  - For Dedicated Tier, you can only restore data from a smaller node size to a larger node size.  - You cannot restore data from a Dedicated Tier cluster to a Developer Tier cluster.  For Developer Tier clusters, you cannot create restore tasks via API.
     * @param projectId The ID of the project. You can get the project ID from the response of [List all accessible projects.](#tag/Project/operation/ListProjects). (required)
     * @param body  (required)
     ...
     */
    public com.squareup.okhttp.Call createRestoreTaskAsync(String projectId, CreateRestoreReq body, final ApiCallback<CreateRestoreResp> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createRestoreTaskCall(projectId, body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<CreateRestoreResp>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /* Build call for getRestoreTask */
    private com.squareup.okhttp.Call getRestoreTaskCall(String projectId, String restoreId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // verify the required parameter 'projectId' is set
        if (projectId == null) {
            throw new ApiException("Missing the required parameter 'projectId' when calling getRestoreTask(Async)");
        }
        
        // verify the required parameter 'restoreId' is set
        if (restoreId == null) {
            throw new ApiException("Missing the required parameter 'restoreId' when calling getRestoreTask(Async)");
        }
        

        // create path and map variables
        String localVarPath = "/api/v1beta/projects/{project_id}/restores/{restore_id}".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "project_id" + "\\}", apiClient.escapeString(projectId.toString()))
        .replaceAll("\\{" + "restore_id" + "\\}", apiClient.escapeString(restoreId.toString()));
     ...
     * @param restoreId The ID of the restore task. (required)
     * @return GetRestoreResp
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public GetRestoreResp getRestoreTask(String projectId, String restoreId) throws ApiException {
        ApiResponse<GetRestoreResp> resp = getRestoreTaskWithHttpInfo(projectId, restoreId);
        return resp.getData();
    }
     ...
     * @param projectId The ID of your project. You can get the project ID from the response of [List all accessible projects.](#tag/Project/operation/ListProjects). (required)
     * @param restoreId The ID of the restore task. (required)
     * @return ApiResponse&lt;GetRestoreResp&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<GetRestoreResp> getRestoreTaskWithHttpInfo(String projectId, String restoreId) throws ApiException {
        com.squareup.okhttp.Call call = getRestoreTaskCall(projectId, restoreId, null, null);
        Type localVarReturnType = new TypeToken<GetRestoreResp>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Get a restore task. (asynchronously)
     *  For Developer Tier clusters, you cannot manage restore tasks via API.
     * @param projectId The ID of your project. You can get the project ID from the response of [List all accessible projects.](#tag/Project/operation/ListProjects). (required)
     * @param restoreId The ID of the restore task. (required)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getRestoreTaskAsync(String projectId, String restoreId, final ApiCallback<GetRestoreResp> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getRestoreTaskCall(projectId, restoreId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetRestoreResp>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /* Build call for listRestoreTasks */
    private com.squareup.okhttp.Call listRestoreTasksCall(String projectId, Integer page, Integer pageSize, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // verify the required parameter 'projectId' is set
        if (projectId == null) {
            throw new ApiException("Missing the required parameter 'projectId' when calling listRestoreTasks(Async)");
        }
     ...
     * @return ListRestoreResp
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ListRestoreResp listRestoreTasks(String projectId, Integer page, Integer pageSize) throws ApiException {
        ApiResponse<ListRestoreResp> resp = listRestoreTasksWithHttpInfo(projectId, page, pageSize);
        return resp.getData();
    }
     ...
     * @param page The number of pages. (optional, default to 1)
     * @param pageSize The size of a page. (optional, default to 10)
     * @return ApiResponse&lt;ListRestoreResp&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ListRestoreResp> listRestoreTasksWithHttpInfo(String projectId, Integer page, Integer pageSize) throws ApiException {
        com.squareup.okhttp.Call call = listRestoreTasksCall(projectId, page, pageSize, null, null);
        Type localVarReturnType = new TypeToken<ListRestoreResp>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * List the restore tasks in a project. (asynchronously)
     *  For Developer Tier clusters, you cannot create or manage restore tasks via API.
     * @param projectId The ID of your project. You can get the project ID from the response of [List all accessible projects.](#tag/Project/operation/ListProjects). (required)
     * @param page The number of pages. (optional, default to 1)
     * @param pageSize The size of a page. (optional, default to 10)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call listRestoreTasksAsync(String projectId, Integer page, Integer pageSize, final ApiCallback<ListRestoreResp> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = listRestoreTasksCall(projectId, page, pageSize, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ListRestoreResp>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
