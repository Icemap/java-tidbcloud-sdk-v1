...
import com.github.icemap.model.CreateBackupReq;
import com.github.icemap.model.CreateBackupResp;
import com.github.icemap.model.InlineResponseDefault;
import com.github.icemap.model.InlineResponse400;
import com.github.icemap.model.GetBackupOfClusterResp;
import com.github.icemap.model.ListBackupOfClusterResp;
...
public class BackupApi {
    ...
    private com.squareup.okhttp.Call createBackupCall(String projectId, String clusterId, CreateBackupReq body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        if (clusterId == null) {
            throw new ApiException("Missing the required parameter 'clusterId' when calling createBackup(Async)");
        }
        ...
        String localVarPath = "/api/v1beta/projects/{project_id}/clusters/{cluster_id}/backups".replaceAll("\\{format\\}","json")
     ...
     * @param projectId The ID of your project. You can get the project ID from the response of [List all accessible projects.](#tag/Project/operation/ListProjects). (required)
     * @param clusterId The ID of your cluster that you want to take a manual backup. You can get the cluster ID from the response of [Get all clusters in a project](#tag/Cluster/operation/ListClustersOfProject). (required)
     * @param body  (required)
     * @return CreateBackupResp
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public CreateBackupResp createBackup(String projectId, String clusterId, CreateBackupReq body) throws ApiException {
        ApiResponse<CreateBackupResp> resp = createBackupWithHttpInfo(projectId, clusterId, body);
        return resp.getData();
    }
     ...
     * @param clusterId The ID of your cluster that you want to take a manual backup. You can get the cluster ID from the response of [Get all clusters in a project](#tag/Cluster/operation/ListClustersOfProject). (required)
     * @param body  (required)
     * @return ApiResponse&lt;CreateBackupResp&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<CreateBackupResp> createBackupWithHttpInfo(String projectId, String clusterId, CreateBackupReq body) throws ApiException {
        com.squareup.okhttp.Call call = createBackupCall(projectId, clusterId, body, null, null);
        Type localVarReturnType = new TypeToken<CreateBackupResp>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Create a backup for a cluster. (asynchronously)
     * - For Dedicated Tier clusters, you can create as many manual backups as you need. - For Developer Tier clusters, you cannot create backups via API. You can use [Dumpling](https://docs.pingcap.com/tidb/stable/dumpling-overview) to export your data as backups.
     * @param projectId The ID of your project. You can get the project ID from the response of [List all accessible projects.](#tag/Project/operation/ListProjects). (required)
     * @param clusterId The ID of your cluster that you want to take a manual backup. You can get the cluster ID from the response of [Get all clusters in a project](#tag/Cluster/operation/ListClustersOfProject). (required)
     * @param body  (required)
     ...
     */
    public com.squareup.okhttp.Call createBackupAsync(String projectId, String clusterId, CreateBackupReq body, final ApiCallback<CreateBackupResp> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createBackupCall(projectId, clusterId, body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<CreateBackupResp>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /* Build call for deleteBackup */
    private com.squareup.okhttp.Call deleteBackupCall(String projectId, String clusterId, String backupId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // verify the required parameter 'clusterId' is set
        if (clusterId == null) {
            throw new ApiException("Missing the required parameter 'clusterId' when calling deleteBackup(Async)");
        }
        ...
        // create path and map variables
        String localVarPath = "/api/v1beta/projects/{project_id}/clusters/{cluster_id}/backups/{backup_id}".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "project_id" + "\\}", apiClient.escapeString(projectId.toString()))
        .replaceAll("\\{" + "cluster_id" + "\\}", apiClient.escapeString(clusterId.toString()))
        .replaceAll("\\{" + "backup_id" + "\\}", apiClient.escapeString(backupId.toString()));
     ...
     * @param projectId The ID of your project. You can get the project ID from the response of [List all accessible projects.](#tag/Project/operation/ListProjects). (required)
     * @param clusterId The ID of your cluster. You can get the cluster ID from the response of [Get all clusters in a project](#tag/Cluster/operation/ListClustersOfProject). (required)
     * @param backupId The ID of the backup. You can get the backup ID from the response of [List all backups for a cluster](#tag/Project/operation/ListBackUpOfCluster). (required)
     * @return Object
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Object deleteBackup(String projectId, String clusterId, String backupId) throws ApiException {
        ApiResponse<Object> resp = deleteBackupWithHttpInfo(projectId, clusterId, backupId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Object> deleteBackupWithHttpInfo(String projectId, String clusterId, String backupId) throws ApiException {
        com.squareup.okhttp.Call call = deleteBackupCall(projectId, clusterId, backupId, null, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Delete a backup for a cluster. (asynchronously)
     * For Developer Tier clusters, you cannot manage backups via API. You can use [Dumpling](https://docs.pingcap.com/tidb/stable/dumpling-overview) to export your data as backups.
     * @param projectId The ID of your project. You can get the project ID from the response of [List all accessible projects.](#tag/Project/operation/ListProjects). (required)
     * @param clusterId The ID of your cluster. You can get the cluster ID from the response of [Get all clusters in a project](#tag/Cluster/operation/ListClustersOfProject). (required)
     * @param backupId The ID of the backup. You can get the backup ID from the response of [List all backups for a cluster](#tag/Project/operation/ListBackUpOfCluster). (required)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call deleteBackupAsync(String projectId, String clusterId, String backupId, final ApiCallback<Object> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteBackupCall(projectId, clusterId, backupId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /* Build call for getBackupOfCluster */
    private com.squareup.okhttp.Call getBackupOfClusterCall(String projectId, String clusterId, String backupId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // verify the required parameter 'projectId' is set
        if (projectId == null) {
            throw new ApiException("Missing the required parameter 'projectId' when calling getBackupOfCluster(Async)");
        }
        
        // verify the required parameter 'clusterId' is set
        if (clusterId == null) {
            throw new ApiException("Missing the required parameter 'clusterId' when calling getBackupOfCluster(Async)");
        }
        
        // verify the required parameter 'backupId' is set
        if (backupId == null) {
            throw new ApiException("Missing the required parameter 'backupId' when calling getBackupOfCluster(Async)");
        }
     ...
     * @return GetBackupOfClusterResp
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public GetBackupOfClusterResp getBackupOfCluster(String projectId, String clusterId, String backupId) throws ApiException {
        ApiResponse<GetBackupOfClusterResp> resp = getBackupOfClusterWithHttpInfo(projectId, clusterId, backupId);
        return resp.getData();
    }
     ...
     * @param clusterId The ID of your cluster. You can get the cluster ID from the response of [Get all clusters in a project](#tag/Cluster/operation/ListClustersOfProject). (required)
     * @param backupId The ID of the backup. (required)
     * @return ApiResponse&lt;GetBackupOfClusterResp&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<GetBackupOfClusterResp> getBackupOfClusterWithHttpInfo(String projectId, String clusterId, String backupId) throws ApiException {
        com.squareup.okhttp.Call call = getBackupOfClusterCall(projectId, clusterId, backupId, null, null);
        Type localVarReturnType = new TypeToken<GetBackupOfClusterResp>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Get a backup for a cluster. (asynchronously)
     * For Developer Tier clusters, you cannot manage backups via API. You can use [Dumpling](https://docs.pingcap.com/tidb/stable/dumpling-overview) to export your data as backups.
     * @param projectId The ID of your project. You can get the project ID from the response of [List all accessible projects.](#tag/Project/operation/ListProjects). (required)
     * @param clusterId The ID of your cluster. You can get the cluster ID from the response of [Get all clusters in a project](#tag/Cluster/operation/ListClustersOfProject). (required)
     * @param backupId The ID of the backup. (required)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getBackupOfClusterAsync(String projectId, String clusterId, String backupId, final ApiCallback<GetBackupOfClusterResp> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getBackupOfClusterCall(projectId, clusterId, backupId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetBackupOfClusterResp>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /* Build call for listBackUpOfCluster */
    private com.squareup.okhttp.Call listBackUpOfClusterCall(String projectId, String clusterId, Integer page, Integer pageSize, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // verify the required parameter 'projectId' is set
        if (projectId == null) {
            throw new ApiException("Missing the required parameter 'projectId' when calling listBackUpOfCluster(Async)");
        }
        
        // verify the required parameter 'clusterId' is set
        if (clusterId == null) {
            throw new ApiException("Missing the required parameter 'clusterId' when calling listBackUpOfCluster(Async)");
        }
     ...
     * @return ListBackupOfClusterResp
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ListBackupOfClusterResp listBackUpOfCluster(String projectId, String clusterId, Integer page, Integer pageSize) throws ApiException {
        ApiResponse<ListBackupOfClusterResp> resp = listBackUpOfClusterWithHttpInfo(projectId, clusterId, page, pageSize);
        return resp.getData();
    }
     ...
     * @param page The number of pages. (optional, default to 1)
     * @param pageSize The size of a page. (optional, default to 10)
     * @return ApiResponse&lt;ListBackupOfClusterResp&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ListBackupOfClusterResp> listBackUpOfClusterWithHttpInfo(String projectId, String clusterId, Integer page, Integer pageSize) throws ApiException {
        com.squareup.okhttp.Call call = listBackUpOfClusterCall(projectId, clusterId, page, pageSize, null, null);
        Type localVarReturnType = new TypeToken<ListBackupOfClusterResp>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * List all backups for a cluster. (asynchronously)
     * For Developer Tier clusters, you cannot manage backups via API. You can use [Dumpling](https://docs.pingcap.com/tidb/stable/dumpling-overview) to export your data as backups.
     * @param projectId The ID of your project. You can get the project ID from the response of [List all accessible projects.](#tag/Project/operation/ListProjects). (required)
     * @param clusterId The ID of your cluster. You can get the cluster ID from the response of [Get all clusters in a project](#tag/Cluster/operation/ListClustersOfProject). (required)
     * @param page The number of pages. (optional, default to 1)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call listBackUpOfClusterAsync(String projectId, String clusterId, Integer page, Integer pageSize, final ApiCallback<ListBackupOfClusterResp> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = listBackUpOfClusterCall(projectId, clusterId, page, pageSize, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ListBackupOfClusterResp>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
