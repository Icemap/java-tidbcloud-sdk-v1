...
import com.github.icemap.model.GetClustersOfProjectRespStatusConnectionStrings;
import com.github.icemap.model.GetClustersOfProjectRespStatusNodeMap;
 ...
 */
@ApiModel(description = "The status of the cluster.")
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2022-09-20T12:31:51.097+08:00")
public class GetClustersOfProjectRespStatus   {
  @SerializedName("tidb_version")
  private String tidbVersion = null;
  ...
  private GetClustersOfProjectRespStatusNodeMap nodeMap = null;

  @SerializedName("connection_strings")
  private GetClustersOfProjectRespStatusConnectionStrings connectionStrings = null;

  public GetClustersOfProjectRespStatus tidbVersion(String tidbVersion) {
   ...
   * @return tidbVersion
  **/
  @ApiModelProperty(example = "v6.1.0", value = "TiDB version.")
  public String getTidbVersion() {
    return tidbVersion;
  }

  public void setTidbVersion(String tidbVersion) {
    this.tidbVersion = tidbVersion;
  }

  public GetClustersOfProjectRespStatus clusterStatus(ClusterStatusEnum clusterStatus) {
  ...
  **/
  @ApiModelProperty(example = "AVAILABLE", value = "Status of the cluster.")
  ...
  public GetClustersOfProjectRespStatus nodeMap(GetClustersOfProjectRespStatusNodeMap nodeMap) {
  ...
  **/
  ...
  public GetClustersOfProjectRespStatusNodeMap getNodeMap() {
    return nodeMap;
  }

  public void setNodeMap(GetClustersOfProjectRespStatusNodeMap nodeMap) {
    this.nodeMap = nodeMap;
  }

  public GetClustersOfProjectRespStatus connectionStrings(GetClustersOfProjectRespStatusConnectionStrings connectionStrings) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "")
  public GetClustersOfProjectRespStatusConnectionStrings getConnectionStrings() {
    return connectionStrings;
  }

  public void setConnectionStrings(GetClustersOfProjectRespStatusConnectionStrings connectionStrings) {
    this.connectionStrings = connectionStrings;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GetClustersOfProjectRespStatus getClustersOfProjectRespStatus = (GetClustersOfProjectRespStatus) o;
    return Objects.equals(this.tidbVersion, getClustersOfProjectRespStatus.tidbVersion) &&
        Objects.equals(this.clusterStatus, getClustersOfProjectRespStatus.clusterStatus) &&
        Objects.equals(this.nodeMap, getClustersOfProjectRespStatus.nodeMap) &&
        Objects.equals(this.connectionStrings, getClustersOfProjectRespStatus.connectionStrings);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tidbVersion, clusterStatus, nodeMap, connectionStrings);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetClustersOfProjectRespStatus {\n");
    
    sb.append("    tidbVersion: ").append(toIndentedString(tidbVersion)).append("\n");
