...
public class GetClustersOfProjectRespStatusNodeMapTikv   {
  ...
  public GetClustersOfProjectRespStatusNodeMapTikv nodeName(String nodeName) {
   ...
   * @return nodeName
  **/
  @ApiModelProperty(example = "tikv-0", value = "The name of a node in the cluster.")
  ...
  public GetClustersOfProjectRespStatusNodeMapTikv availabilityZone(String availabilityZone) {
  ...
  **/
  ...
  public GetClustersOfProjectRespStatusNodeMapTikv nodeSize(String nodeSize) {
   ...
   * @return nodeSize
  **/
  @ApiModelProperty(example = "8C64G", value = "The size of the TiKV component in the cluster.")
  ...
  public GetClustersOfProjectRespStatusNodeMapTikv vcpuNum(Integer vcpuNum) {
  ...
  **/
  ...
  public GetClustersOfProjectRespStatusNodeMapTikv ramBytes(String ramBytes) {
  ...
  **/
  ...
  public GetClustersOfProjectRespStatusNodeMapTikv storageSizeGib(Integer storageSizeGib) {
  ...
  **/
  ...
  public GetClustersOfProjectRespStatusNodeMapTikv status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GetClustersOfProjectRespStatusNodeMapTikv getClustersOfProjectRespStatusNodeMapTikv = (GetClustersOfProjectRespStatusNodeMapTikv) o;
    return Objects.equals(this.nodeName, getClustersOfProjectRespStatusNodeMapTikv.nodeName) &&
        Objects.equals(this.availabilityZone, getClustersOfProjectRespStatusNodeMapTikv.availabilityZone) &&
        Objects.equals(this.nodeSize, getClustersOfProjectRespStatusNodeMapTikv.nodeSize) &&
        Objects.equals(this.vcpuNum, getClustersOfProjectRespStatusNodeMapTikv.vcpuNum) &&
        Objects.equals(this.ramBytes, getClustersOfProjectRespStatusNodeMapTikv.ramBytes) &&
        Objects.equals(this.storageSizeGib, getClustersOfProjectRespStatusNodeMapTikv.storageSizeGib) &&
        Objects.equals(this.status, getClustersOfProjectRespStatusNodeMapTikv.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetClustersOfProjectRespStatusNodeMapTikv {\n");
