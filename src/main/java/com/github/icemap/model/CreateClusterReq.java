...
import com.github.icemap.model.Apiv1betaprojectsprojectIdclustersConfig;
 ...
 */
@ApiModel(description = "CreateClusterReq is the request for creating cluster.")
...
public class CreateClusterReq   {
  ...
  private Apiv1betaprojectsprojectIdclustersConfig config = null;

  public CreateClusterReq name(String name) {
    this.name = name;
    return this;
  }
   ...
   * @return name
  **/
  @ApiModelProperty(example = "Cluster0", required = true, value = "The name of the cluster. The name must be 4-64 characters that can only include numbers, letters, and hyphens, and the first and last character must be a letter or number.")
  ...
  public CreateClusterReq clusterType(ClusterTypeEnum clusterType) {
   ...
   * @return clusterType
  **/
  @ApiModelProperty(example = "DEDICATED", required = true, value = "The cluster type. - `\"DEVELOPER\"`: create a [Developer Tier](https://docs.pingcap.com/tidbcloud/select-cluster-tier#developer-tier) cluster - `\"DEDICATED\"`: create a [Dedicated Tier](https://docs.pingcap.com/tidbcloud/select-cluster-tier#dedicated-tier) cluster. Before creating a Dedicated Tier cluster, you must [set a Project CIDR](https://docs.pingcap.com/tidbcloud/set-up-vpc-peering-connections#prerequisite-set-a-project-cidr) on [TiDB Cloud console](https://tidbcloud.com/).")
  ...
  public CreateClusterReq cloudProvider(CloudProviderEnum cloudProvider) {
  ...
  **/
  @ApiModelProperty(example = "AWS", required = true, value = "The cloud provider on which your TiDB cluster is hosted. - `\"AWS\"`: the Amazon Web Services cloud provider - `\"GCP\"`: the Google Cloud Platform cloud provider")
  ...
  public CreateClusterReq region(String region) {
    this.region = region;
    return this;
  }
   ...
   * @return region
  **/
  @ApiModelProperty(example = "us-west-2", required = true, value = "The region value should match the cloud provider's region code. You can get the complete list of available regions from the response of [List the cloud providers, regions and available specifications](#tag/Cluster/operation/ListProviderRegions).  For the detailed information on each region, refer to the documentation of the corresponding cloud provider ([AWS](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-regions-availability-zones.html) | [GCP](https://cloud.google.com/about/locations#americas)).  For example, if you want to deploy the cluster in the Oregon region for AWS, set the value to `\"us-west-2\"`.")
  ...
  public CreateClusterReq config(Apiv1betaprojectsprojectIdclustersConfig config) {
    this.config = config;
    return this;
  }
  ...
  **/
  ...
  public Apiv1betaprojectsprojectIdclustersConfig getConfig() {
    return config;
  }

  public void setConfig(Apiv1betaprojectsprojectIdclustersConfig config) {
    this.config = config;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.name, createClusterReq.name) &&
        ...
        Objects.equals(this.cloudProvider, createClusterReq.cloudProvider) &&
        Objects.equals(this.region, createClusterReq.region) &&
        Objects.equals(this.config, createClusterReq.config);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, clusterType, cloudProvider, region, config);
  }
