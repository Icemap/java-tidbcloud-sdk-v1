...
public class OpenapiGetBackupOfClusterResp   {
  ...
  public OpenapiGetBackupOfClusterResp id(String id) {
    this.id = id;
    return this;
  }
   ...
   * @return id
  **/
  @ApiModelProperty(example = "1", value = "The ID of the backup.")
  public String getId() {
    return id;
  }
  ...
  public OpenapiGetBackupOfClusterResp name(String name) {
    this.name = name;
    return this;
  }
   ...
   * @return name
  **/
  @ApiModelProperty(example = "backup-1", value = "The name of the backup.")
  ...
  public OpenapiGetBackupOfClusterResp description(String description) {
   ...
   * @return description
  **/
  @ApiModelProperty(example = "backup for cluster upgrade in 2022/06/07", value = "The description of the backup. It is specified by the user when taking a manual type backup. It helps you add additional information to the backup.")
  ...
  public OpenapiGetBackupOfClusterResp type(TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   * @return type
  **/
  @ApiModelProperty(example = "MANUAL", value = "The type of backup. TiDB Cloud only supports manual and auto backup. For more information, see [TiDB Cloud Documentation](https://docs.pingcap.com/tidbcloud/backup-and-restore#backup).")
  ...
  public OpenapiGetBackupOfClusterResp createTimestamp(DateTime createTimestamp) {
  ...
  **/
  @ApiModelProperty(example = "2020-01-01T00:00:00Z", value = "The creation time of the backup in UTC. The time format follows the [ISO8601](http://en.wikipedia.org/wiki/ISO_8601) standard, which is `YYYY-MM-DD` (year-month-day) + T +`HH:MM:SS` (hour-minutes-seconds) + Z. For example, `2020-01-01T00:00:00Z`.")
  ...
  public OpenapiGetBackupOfClusterResp size(String size) {
    this.size = size;
    return this;
  }
   ...
   * @return size
  **/
  @ApiModelProperty(example = "102400", value = "The bytes of the backup.")
  ...
  public OpenapiGetBackupOfClusterResp status(StatusEnum status) {
    this.status = status;
    return this;
  }
   ...
   * @return status
  **/
  @ApiModelProperty(example = "SUCCESS", value = "The status of backup.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    OpenapiGetBackupOfClusterResp openapiGetBackupOfClusterResp = (OpenapiGetBackupOfClusterResp) o;
    return Objects.equals(this.id, openapiGetBackupOfClusterResp.id) &&
        Objects.equals(this.name, openapiGetBackupOfClusterResp.name) &&
        Objects.equals(this.description, openapiGetBackupOfClusterResp.description) &&
        Objects.equals(this.type, openapiGetBackupOfClusterResp.type) &&
        Objects.equals(this.createTimestamp, openapiGetBackupOfClusterResp.createTimestamp) &&
        Objects.equals(this.size, openapiGetBackupOfClusterResp.size) &&
        Objects.equals(this.status, openapiGetBackupOfClusterResp.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, type, createTimestamp, size, status);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OpenapiGetBackupOfClusterResp {\n");
