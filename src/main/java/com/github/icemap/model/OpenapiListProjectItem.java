...
public class OpenapiListProjectItem   {
  ...
  private Long clusterCount = null;
  ...
  public OpenapiListProjectItem id(String id) {
    this.id = id;
    return this;
  }
   ...
   * @return id
  **/
  @ApiModelProperty(example = "1", value = "The ID of the project.")
  public String getId() {
    return id;
  }
  ...
  public OpenapiListProjectItem orgId(String orgId) {
    this.orgId = orgId;
    return this;
  }
   ...
   * @return orgId
  **/
  @ApiModelProperty(example = "1", value = "The ID of the TiDB Cloud organization to which the project belongs.")
  ...
  public OpenapiListProjectItem name(String name) {
    this.name = name;
    return this;
  }
   ...
   * @return name
  **/
  @ApiModelProperty(example = "default_project", value = "The name of the project.")
  ...
  public OpenapiListProjectItem clusterCount(Long clusterCount) {
   ...
   * @return clusterCount
  **/
  @ApiModelProperty(example = "4", value = "The number of TiDB Cloud clusters deployed in the project.")
  ...
  public OpenapiListProjectItem userCount(Long userCount) {
   ...
   * @return userCount
  **/
  @ApiModelProperty(example = "10", value = "The number of users in the project.")
  ...
  public OpenapiListProjectItem createTimestamp(String createTimestamp) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    OpenapiListProjectItem openapiListProjectItem = (OpenapiListProjectItem) o;
    return Objects.equals(this.id, openapiListProjectItem.id) &&
        Objects.equals(this.orgId, openapiListProjectItem.orgId) &&
        Objects.equals(this.name, openapiListProjectItem.name) &&
        Objects.equals(this.clusterCount, openapiListProjectItem.clusterCount) &&
        Objects.equals(this.userCount, openapiListProjectItem.userCount) &&
        Objects.equals(this.createTimestamp, openapiListProjectItem.createTimestamp);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, orgId, name, clusterCount, userCount, createTimestamp);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OpenapiListProjectItem {\n");
