...
public class ListBackupOfClusterRespItems   {
  ...
  public ListBackupOfClusterRespItems id(String id) {
    this.id = id;
    return this;
  }
   ...
   * @return id
  **/
  @ApiModelProperty(example = "1", value = "The ID of the backup. It is generated by TiDB Cloud.")
  public String getId() {
    return id;
  }
  ...
  public ListBackupOfClusterRespItems name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public ListBackupOfClusterRespItems description(String description) {
  ...
  **/
  ...
  public ListBackupOfClusterRespItems type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public ListBackupOfClusterRespItems createTimestamp(DateTime createTimestamp) {
  ...
  **/
  ...
  public ListBackupOfClusterRespItems size(String size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public ListBackupOfClusterRespItems status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ListBackupOfClusterRespItems listBackupOfClusterRespItems = (ListBackupOfClusterRespItems) o;
    return Objects.equals(this.id, listBackupOfClusterRespItems.id) &&
        Objects.equals(this.name, listBackupOfClusterRespItems.name) &&
        Objects.equals(this.description, listBackupOfClusterRespItems.description) &&
        Objects.equals(this.type, listBackupOfClusterRespItems.type) &&
        Objects.equals(this.createTimestamp, listBackupOfClusterRespItems.createTimestamp) &&
        Objects.equals(this.size, listBackupOfClusterRespItems.size) &&
        Objects.equals(this.status, listBackupOfClusterRespItems.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListBackupOfClusterRespItems {\n");
