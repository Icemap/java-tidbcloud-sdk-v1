...
import com.github.icemap.model.GetProviderRegionsRespTidb;
import com.github.icemap.model.GetProviderRegionsRespTiflash;
import com.github.icemap.model.GetProviderRegionsRespTikv;
...
public class OpenapiListProviderRegionsItem   {
  ...
  @SerializedName("tidb")
  private List<GetProviderRegionsRespTidb> tidb = new ArrayList<GetProviderRegionsRespTidb>();

  @SerializedName("tikv")
  private List<GetProviderRegionsRespTikv> tikv = new ArrayList<GetProviderRegionsRespTikv>();

  @SerializedName("tiflash")
  private List<GetProviderRegionsRespTiflash> tiflash = new ArrayList<GetProviderRegionsRespTiflash>();

  public OpenapiListProviderRegionsItem clusterType(ClusterTypeEnum clusterType) {
   ...
   * @return clusterType
  **/
  @ApiModelProperty(example = "DEDICATED", value = "The cluster type. - `\"DEVELOPER\"`: a [Developer Tier](https://docs.pingcap.com/tidbcloud/select-cluster-tier#developer-tier) cluster - `\"DEDICATED\"`: a [Dedicated Tier](https://docs.pingcap.com/tidbcloud/select-cluster-tier#dedicated-tier) cluster")
  ...
  public OpenapiListProviderRegionsItem cloudProvider(CloudProviderEnum cloudProvider) {
  ...
  **/
  @ApiModelProperty(example = "AWS", value = "The cloud provider on which your TiDB cluster is hosted. - `\"AWS\"`: the Amazon Web Services cloud provider - `\"GCP\"`: the Google Cloud Platform cloud provider")
  ...
  public OpenapiListProviderRegionsItem region(String region) {
    this.region = region;
    return this;
  }
   ...
   * @return region
  **/
  @ApiModelProperty(example = "us-west-2", value = "The region in which your TiDB cluster is hosted.  For the detailed information on each region, refer to the documentation of the corresponding cloud provider ([AWS](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-regions-availability-zones.html) | [GCP](https://cloud.google.com/about/locations#americas)).  For example, `\"us-west-2\"` refers to Oregon for AWS.")
  ...
  public OpenapiListProviderRegionsItem tidb(List<GetProviderRegionsRespTidb> tidb) {
    this.tidb = tidb;
    return this;
  }

  public OpenapiListProviderRegionsItem addTidbItem(GetProviderRegionsRespTidb tidbItem) {
    this.tidb.add(tidbItem);
    return this;
  }
   ...
   * @return tidb
  **/
  @ApiModelProperty(example = "null", value = "The list of TiDB specifications in the region.")
  public List<GetProviderRegionsRespTidb> getTidb() {
    return tidb;
  }

  public void setTidb(List<GetProviderRegionsRespTidb> tidb) {
    this.tidb = tidb;
  }

  public OpenapiListProviderRegionsItem tikv(List<GetProviderRegionsRespTikv> tikv) {
    this.tikv = tikv;
    return this;
  }

  public OpenapiListProviderRegionsItem addTikvItem(GetProviderRegionsRespTikv tikvItem) {
    this.tikv.add(tikvItem);
    return this;
  }
   ...
   * @return tikv
  **/
  @ApiModelProperty(example = "null", value = "The list of TiKV specifications in the region.")
  public List<GetProviderRegionsRespTikv> getTikv() {
    return tikv;
  }

  public void setTikv(List<GetProviderRegionsRespTikv> tikv) {
    this.tikv = tikv;
  }

  public OpenapiListProviderRegionsItem tiflash(List<GetProviderRegionsRespTiflash> tiflash) {
    this.tiflash = tiflash;
    return this;
  }

  public OpenapiListProviderRegionsItem addTiflashItem(GetProviderRegionsRespTiflash tiflashItem) {
    this.tiflash.add(tiflashItem);
    return this;
  }
   ...
   * @return tiflash
  **/
  @ApiModelProperty(example = "null", value = "The list of TiFlash specifications in the region.")
  public List<GetProviderRegionsRespTiflash> getTiflash() {
    return tiflash;
  }

  public void setTiflash(List<GetProviderRegionsRespTiflash> tiflash) {
    this.tiflash = tiflash;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    OpenapiListProviderRegionsItem openapiListProviderRegionsItem = (OpenapiListProviderRegionsItem) o;
    return Objects.equals(this.clusterType, openapiListProviderRegionsItem.clusterType) &&
        Objects.equals(this.cloudProvider, openapiListProviderRegionsItem.cloudProvider) &&
        Objects.equals(this.region, openapiListProviderRegionsItem.region) &&
        Objects.equals(this.tidb, openapiListProviderRegionsItem.tidb) &&
        Objects.equals(this.tikv, openapiListProviderRegionsItem.tikv) &&
        Objects.equals(this.tiflash, openapiListProviderRegionsItem.tiflash);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clusterType, cloudProvider, region, tidb, tikv, tiflash);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OpenapiListProviderRegionsItem {\n");
    
    sb.append("    clusterType: ").append(toIndentedString(clusterType)).append("\n");
    sb.append("    cloudProvider: ").append(toIndentedString(cloudProvider)).append("\n");
    sb.append("    region: ").append(toIndentedString(region)).append("\n");
    sb.append("    tidb: ").append(toIndentedString(tidb)).append("\n");
    sb.append("    tikv: ").append(toIndentedString(tikv)).append("\n");
    sb.append("    tiflash: ").append(toIndentedString(tiflash)).append("\n");
    sb.append("}");
    return sb.toString();
  }
